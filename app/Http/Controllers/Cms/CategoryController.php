...
class CategoryController extends BaseController
{
    ...
    {
        $categories = $this->categoryRepository->listParentCategories();
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'title'      =>  'required|unique:resource_categories|max:191',
        ]);
    ...
    public function edit($id)
    {
        ...
        $this->setPageTitle('Categories', 'Edit Category : '.$targetCategory->title);
